...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT( /* Numbers, left half Alphas */
        ...
        KC_LCTL,   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,    KC_LEFT,   KC_DOWN, KC_RIGHT,
        KC_LSFT,   KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,               KC_ENT,
        KC_GRV,     KC_LCTL,KC_LGUI, KC_LALT, MO(1),   KC_SPC,             TT(2)
    ),
    [1] = LAYOUT( /* Second set of numbers, mirrored right half Alphas, */
        KC_GRV,    KC_6,   KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,   KC_EQL,
    ...
    [2] = LAYOUT( /* F-keys, Numbers, Mouse Keys */
        _______,   KC_F1,  KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F11,    KC_F12,
        ...
        _______,_______,   KC_BTN3, KC_WH_D, KC_WH_U, KC_BTN1,            _______
    ),
    [3] = LAYOUT( /* Numpad, Media Controls, Reboot on Encoder button*/
        _______,   KC_DEL, KC_ESC,  KC_PSLS, KC_PAST, KC_PMNS, KC_MPLY,   KC_MSTP,
        _______,   KC_BSPC,KC_P7,   KC_P8,   KC_P9,   KC_PMNS,            _______,
        KC_HOME,   KC_PGUP,KC_P4,   KC_P5,   KC_P6,   KC_PPLS, QK_BOOT,   _______, _______,
        KC_END,    KC_PGDN,KC_P1,   KC_P2,   KC_P3,   KC_PPLS,            _______,
        _______,   _______,KC_DEL,  KC_P0,   KC_PDOT, KC_PENT,            KC_NUM
    ),
};
